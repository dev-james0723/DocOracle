...
DocOracle is an end-to-end document intelligence project: it turns PDFs into structured, citation-grounded knowledge bases with searchable text, glossary data, section maps, visual-asset metadata, and an optional deployable website.

- Live demo: [decca-oracle.manus.space](https://decca-oracle.manus.space)
- Core stack: Python pipeline, React/Express/tRPC website, Gemini Vision, and retrieval-ready JSON
- Best fit: research, education, technical documentation, music production, and long-form knowledge work
- Repository role: flagship AI/document-processing project for this portfolio

The README screenshots are intentionally kept out of the public document until stable repository-hosted image paths are available.
